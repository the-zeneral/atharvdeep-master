# Magento 2 Paykun payment method gateway
...
1. Create file [registration.php](https://github.com/mageplaza/magento-2-paykun-payment-method/blob/master/registration.php)
...
1. Now we create file `payment.xml` file in `etc` folder [etc/payment.xml](https://github.com/mageplaza/magento-2-paykun-payment-method/blob/master/etc/payment.xml)
...
Create file [Model/Payment/Simple.php](https://github.com/mageplaza/magento-2-paykun-payment-method/blob/master/Model/Payment/Simple.php)
...
1. Create layout file: [view/frontend/layout/checkout_index_index.xml](https://github.com/mageplaza/magento-2-paykun-payment-method/blob/master/view/frontend/layout/checkout_index_index.xml)
...
- File: [/view/frontend/web/js/view/payment/simple.js](https://github.com/mageplaza/magento-2-paykun-payment-method/blob/master/view/frontend/web/js/view/payment/simple.js)
...
3. Finally, create KO template file [/view/frontend/web/template/payment/simple.html](https://github.com/mageplaza/magento-2-paykun-payment-method/blob/master/view/frontend/web/template/payment/simple.html)
