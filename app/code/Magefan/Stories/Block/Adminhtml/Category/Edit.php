...
namespace Magefan\Stories\Block\Adminhtml\Category;

/**
 * Admin Stories category 
 */
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'id';
        $this->_blockGroup = 'Magefan_Stories';
        $this->_controller = 'adminhtml_category';

        parent::_construct();

        if ($this->_isAllowedAction('Magefan_Stories::stories_category')) {
            $this->buttonList->add(
                'saveandcontinue',
                [
