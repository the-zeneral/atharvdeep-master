...
/**
 * Admin Stories post edit form related products tab
 */
class RelatedProducts extends Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
        ...
        $this->addColumn(
            ...
            [
                ...
                'frame_callback' => array(
                    $this->getLayout()->createBlock('Magefan\Stories\Block\Adminhtml\Grid\Column\Statuses'),
                    'decorateStatus'
                ),
            ]
        );
    ...
    public function getGridUrl()
    {
        return $this->getData(
            ...
            'stories/post/relatedProductsGrid',
            ['_current' => true]
        );
    }
