...
namespace Magefan\Stories\Block\Post\PostList;

use Magento\Store\Model\ScopeInterface;

/**
 * Abstract Stories post list block
 */
abstract class AbstractList extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * @var \Magefan\Stories\Model\ResourceModel\Post\CollectionFactory
     */
    protected $_postCollectionFactory;

    /**
     * @var \Magefan\Stories\Model\ResourceModel\Post\Collection
     */
     ...
     * @param \Magefan\Stories\Model\ResourceModel\Post\CollectionFactory $postCollectionFactory
    ...
    protected function _preparePostCollection()
    {
		...
		//$this->_postCollection->getSelect()->order('publish_time', 'DESC');
        if ($this->getPageSize()) {
