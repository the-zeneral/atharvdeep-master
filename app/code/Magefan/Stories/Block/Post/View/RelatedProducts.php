...
/**
 * Stories post related products block
 */
    ...
    implements \Magento\Framework\DataObject\IdentityInterface
{
    ...
    {
        $post = $this->_coreRegistry->registry('current_stories_post');
        ...
        $this->_itemCollection->setPageSize(
            (int) $this->_scopeConfig->getValue(
                'mfstories/post_view/related_products/number_of_products',
    ...
    public function displayProducts()
    {
        return (bool) $this->_scopeConfig->getValue(
            'mfstories/post_view/related_products/enabled',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return [\Magento\Cms\Model\Page::CACHE_TAG . '_relatedproducts_'.$this->_coreRegistry->registry('current_stories_post')->getId()  ];
    }
}
