...
class Comments extends \Magento\Framework\View\Element\Template
{
    ...
    public function getCommentsType()
    {
        return $this->_scopeConfig->getValue(
            'mfstories/post_view/comments/type', ScopeInterface::SCOPE_STORE
        );
    }
    ...
    public function getNumberOfComments()
    {
        return (int)$this->_scopeConfig->getValue(
            'mfstories/post_view/comments/number_of_comments', ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'mfstories/post_view/comments/fb_app_id', ScopeInterface::SCOPE_STORE
        );
    }
