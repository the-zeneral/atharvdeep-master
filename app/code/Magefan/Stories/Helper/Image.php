 ...
 */
namespace Magefan\Stories\Helper;
...
class Image extends AbstractHelper
{
    ...
    public function __construct(
        ...
        //$result = $this->_mediaDirectory->create('stories');
    ...
    {
        //if (!$this->_processor) {
            $filename = $this->_baseFile ? $this->_mediaDirectory->getAbsolutePath('stories/'.$this->_baseFile) : null;
    ...
    {
        $image_type = substr($this->_baseFile,strpos($this->_baseFile, ".") + 1); 
    	...
    	if($this->_baseFile){
			...
			$this->_height = $height;
			if(!$this->isCached()){
				$path = 'stories/cache/'.$width.'x'.$height;
