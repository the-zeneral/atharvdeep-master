...
namespace Magefan\Stories\Model;

/**
 * Post model
 *
 * @method \Magefan\Stories\Model\ResourceModel\Post _getResource()
 * @method \Magefan\Stories\Model\ResourceModel\Post getResource()
...
class Post extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'magefan_stories_post';
     ...
     * @var string
     */
    protected $_eventObject = 'stories_post';
    ...
    /**
     * @var \Magefan\Stories\Model\ResourceModel\Category\CollectionFactory
     */
     ...
     * @param \Magefan\Stories\Model\ResourceModel\Category\CollectionFactory $categoryCollectionFactory
    ...
    {
        $this->_init('Magefan\Stories\Model\ResourceModel\Post');
    }
    ...
    {
        return 'stories/post/'.$this->getIdentifier();
    }
