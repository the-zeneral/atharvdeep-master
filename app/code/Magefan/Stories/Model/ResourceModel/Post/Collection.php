...
namespace Magefan\Stories\Model\ResourceModel\Post;

/**
 * Stories post collection
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init('Magefan\Stories\Model\Post', 'Magefan\Stories\Model\ResourceModel\Post');
     ...
     * @param array|int|\Magefan\Stories\Model\Category  $category
     * @return $this
     */
    public function addCategoryFilter($category)
    {
        if (!$this->getFlag('category_filter_added')) {
            if ($category instanceof \Magefan\Stories\Model\Category) {
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $select = $connection->select()->from(['cps' => $this->getTable('magefan_stories_post_store')])
            ...
            $select = $connection->select()->from(['cps' => $this->getTable('magefan_stories_post_category')])
                ->where('cps.post_id IN (?)', $items);
    ...
    protected function _renderFiltersBefore()
    {
        foreach(array('store', 'category') as $key) {
            if ($this->getFilter($key)) {
                $this->getSelect()->join(
                    [$key.'_table' => $this->getTable('magefan_stories_post_'.$key)],
