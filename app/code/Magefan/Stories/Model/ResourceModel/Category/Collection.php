...
namespace Magefan\Stories\Model\ResourceModel\Category;

/**
 * Stories category collection
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init('Magefan\Stories\Model\Category', 'Magefan\Stories\Model\ResourceModel\Category');
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $select = $connection->select()->from(['cps' => $this->getTable('magefan_stories_category_store')])
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('magefan_stories_category_store')],
