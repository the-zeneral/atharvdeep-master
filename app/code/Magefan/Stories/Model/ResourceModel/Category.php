...
class Category extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('magefan_stories_category', 'category_id');
    }
    ...
    protected function _beforeDelete(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('magefan_stories_category_store'), $condition);
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $table = $this->getTable('magefan_stories_category_store');
    ...
    protected function _getLoadByIdentifierSelect($identifier, $store, $isActive = null)
    {
        $select = $this->getConnection()->select()->from(
            ...
            ['cps' => $this->getTable('magefan_stories_category_store')],
    ...
    public function lookupStoreIds($categoryId)
    {
        ...
        $select = $adapter->select()->from(
            $this->getTable('magefan_stories_category_store'),
            'store_id'
        )->where(
            'category_id = ?',
            (int)$categoryId
