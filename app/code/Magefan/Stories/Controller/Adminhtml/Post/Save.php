...
/**
 * stories post save controller
 */
class Save extends \Magefan\Stories\Controller\Adminhtml\Post
{
	...
	/**
	 * Before model save
	 * @param  \Magefan\stories\Model\Post $model
    ...
    {
        return $this->fileSystem->getDirectoryWrite(DirectoryList::MEDIA)->getAbsolutePath('stories');
    }
